          ...
          &$fields_readonly)
{
    ...
    $fdf .= " << /T (save)/A << /S /SubmitForm /F (http://192.168.0.99:80/sn_mr_form_save.php)>> >>
  ] \x0d"; // close the Fields array
///F (76.pdf)/ID [ <36b9208950696bc0a5834bc2e34e14c8><c35cabeb60b1ce4ff5081a8d0ada4002>
    // the PDF form filename or URL, if given
    //$fdf .= "<< /F (76.pdf)/ID [ <36b9208950696bc0a5834bc2e34e14c8><c35cabeb60b1ce4ff5081a8d0ada4002> >> >>] \x0d";


    /*
    << /T (save)/A << /S /SubmitForm /F (http://192.168.0.99:80/sn_mr_form_save.php)>> >>
  ]
  /F (http://192.168.0.99/form/2006/4623.pdf)/ID [ <36b9208950696bc0a5834bc2e34e14c8><c35cabeb60b1ce4ff5081a8d0ada4002>
  ] >>
  >>
  endobj
  trailer
  ...
  */
    ...
    if ($pdf_form_url) {
        $fdf .= "/F (" . escape_pdf_string($pdf_form_url) . ")/ID [ <36b9208950696bc0a5834bc2e34e14c8><c35cabeb60b1ce4ff5081a8d0ada4002> \x0d";
    }
